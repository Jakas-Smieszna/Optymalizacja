...
matrix S_zewn(matrix x, bool(**constraints)(matrix, double), int numConstraints, double a = 4.0, matrix = 0, matrix = 0);
matrix S_wewn(matrix x, bool(**constraints)(matrix, double), int numConstraints, double a = 4.0, matrix = 0, matrix = 0);
