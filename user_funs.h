...
matrix ff5R1(matrix, matrix = 0, matrix = 0);
matrix ff5R2(matrix, matrix = 0, matrix = 0);
matrix ff5R3(matrix, matrix = 0, matrix = 0);
matrix ff5RX(matrix, matrix, matrix);
matrix gg5RX(matrix, matrix, matrix);
